            ...
            <div class="maxeditor-body-inner" ref="maxEditorBodyInner">
                <maxeditor-board
                    ...
                    <template v-if="item.type === 'label'">
                        <p style="margin:0"><span class="maxeditor-sigleline" style="width: 70px;display: inline-block;margin-left: -75px;">{{item.label}}</span>
                        ...
                        <div style="width: 100%;height: 100%"
                            ...
                            <div style="text-align: center">
                                <template v-for="img in item.imgs">
                                    <img :src="img.src" :style="{'width':item.imgs.length===1?'100%':'160px','margin':item.imgs.length===1?'0':'4px'}"/>
                                </template>
                            </div>
                        </div>
                    </template>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getBoards() {
                alert(JSON.stringify(this.maxeditor_boards))
            },
            setBoards(boards) {
            ...
            getCurrentSelection(index) {
                ...
                this.current_selection = this.document.getSelection()
                this.maxeditor_current_id = this.maxeditor_boards[index].id
                console.log(this.current_selection.anchorNode.parentElement)
                console.log(this.current_selection.anchorNode)
                console.log(this.current_selection.anchorOffset)
                /*console.log(this.current_selection.isCollapsed)
                console.log(this.current_selection.rangeCount)*/
